...
dirData = 'DEoAI_analysis/python_codes/figure4/(a)/1km/'
dirDataObs = 'DEoAI_analysis/python_codes/figure4/(a)/stations/'
dirFig = 'figures/11_figure4/'

fileout = dirFig + 'pr_yearly_mean.png'
...
isolinhas = np.arange(0,2400,200)
N = len(isolinhas)
mapacor = plt.cm.jet_r
...
fname = dirDataObs + 'pr_Stat_2006-2015_yearly_accumulated_MAD.out'
...
#Make 1km plot
# fname = dirDataObs + 'pr_MAD_Madeira_2006-2015_yearly_accumulated_MAD.out'
fname = dirData + 'pr_MAD_Madeira_2006-2015_yearly_accumulated_MAD.out'
data=Ngl.asciiread(fname,(nrows,ncols),"float")
lat=data[:,1]
lon=data[:,0]
pr=data[:,2]
